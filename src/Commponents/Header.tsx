...
function Header({ }: Props) {
  ...
  return (
    <header className='flex h-[10vh] sticky top-0 flex-row bg-drbgclr text-drfgclr  z-50 shadow-md overflow-x-hidden overflow-y-visible'>
      ...
      <div 
       ...
       className='hidden sm:flex flex-row items-center justify-between'>
        <div
          className='group flex flex-row rounded-3xl border border-transparent   hover:border-drfgclr duration-500 ease-in-out'>
