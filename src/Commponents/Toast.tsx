...
const Toast = (props: Props) => {
  return (
    <div id="toast-success" className="flex items-center w-full max-w-xs p-4 mb-4 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
    ...
    <div className="ml-3 text-sm font-normal">Message Sent Sucessfully.</div>
