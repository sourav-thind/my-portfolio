...
const About = (props: Props) => {
    const refPic = useRef<HTMLDivElement>(null);
    ...
    const x  = useTransform(scrollYProgress, [0,0.2,0.8, 1], [800 , 0, 0, 800]);
    const x2 = useTransform(scrollYProgress, [0,0.2,0.8, 1], [-300, 0, 0, -300]);
    return (
        <div className='bg-drbgclr relative  flex mx-auto justify-center h-[90vh] overflow-hidden'>
