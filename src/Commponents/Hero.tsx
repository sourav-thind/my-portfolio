...
const Hero = (props: Props) => {
  return (
    <section className=' w-full h-screen mx-auto bg-drbgclr '>
      <div className='relative top-[4rem] md:top-[6rem] max-w-7xl mx-auto flex flex-col items-start gap-3 justify-center  ' >
        ...
        <div className='flex flex-col md:flex-row ml-0 md:ml-5 '>
        ...
        <div className='flex justfy-center mx-auto items-center ml-0 md:ml-[8rem] mt-8'>
