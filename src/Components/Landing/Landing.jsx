...
const Landing = () => {
  return (
    ...
    <div className=' w-[2400px] h-[1950px] bg-drbgclr mx-auto'>
        ...
        w-[1200px] h-[1950px] lg:flex-row md:w-[2000px] lg:w-[2200px] '>
            <div className='mt-[10vh] md:ml-[0vw]  md:mt-[20vh] lg:ml-[20vw] '>
            ...
            <div className=' lg:block md:mt-[20vh]  mx-auto lg:ml-0'>
